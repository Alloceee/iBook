...
@section('content')
    <div class="container" style="margin-top: 10px">
        <form method="post" enctype="multipart/form-data" action="{{ route('store') }}" id="article">
            {{ csrf_field() }}
            ...
            <div class="col_full row">
                <div class="col-sm-12">
                    ...
                    <textarea name="article-brief" cols="58" rows="7" tabindex="4"
                              class="form-control" id="article-brief"></textarea>
                </div>
            </div>
            <div class="col_full row">
                <div class="col-sm-6">
                    <label for="article-tags">标签:</label>
                    <input id="article-label" name="article-tags" type="text" class="tags" value=""/>
                </div>
                <div class="col-sm-6">
                    <label for="article-item">栏目:</label>
                    <input id="article-item" name="article-item" type="text" class="tags" value=""/>
            ...
            <input type="hidden" name="article-covers" id="article-covers">
        </form>
    </div>
    ...
    <script src="{{ URL::asset('home/lib/wangEditor-3.1.1/wangEditor-3.1.1/wangEditor-fullscreen-plugin.js') }}"></script>
    <script type="text/javascript">

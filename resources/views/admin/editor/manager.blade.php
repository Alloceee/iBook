    ...
    <section id="map-overlay">
        ...
        <div class="container clearfix">
            ...
            @foreach( $manager as $value)
                <!-- Contact Form
                ============================================= -->
                    <form class="nobottommargin" id="type-insert" name="type-insert"
                          action="{{ route('manager.update') }}" method="post">
                        {{ csrf_field() }}
                        <div class="col_half">
                            <label for="type-insert-name">状态
                                <small>*</small>
                            </label>
                        ...
                        <div class="col_full">
                            <button class="button button-3d nomargin" type="submit" name="type-insert-submit"
                                    value="submit">修改
                            </button>
                        </div>
